...
function initMap() {
    ...
    function promptBookingConfirmation(storeName) {
        ...
        if (userName) {
            const confirmBooking = confirm(`Hi ${userName}! Do you want to book this parking slot ?`);
            if (confirmBooking) {
    ...
    function promptCarNumber(storeName, userName) {
        if (currentUserBooking) {
            ...
            const carNumber = prompt(`Hi ${userName}! Enter your car number for parking please`);
            if (carNumber) {
    ...
    function promptBookingDuration(storeName, userName, carNumber) {
        ...
        const selectedDuration = prompt(`Hi ${userName}! Select booking duration (just enter the number):\n${durationOptions.join('\n')}`);
    ...
    function bookParkingSlot(storeName, userName, carNumber, selectedDuration) {
        ...
        alert(`Parking slot is booked for ${selectedDuration}.`);
    ...
    function removeBookingData(storeName, userName, parkingLocationsRef) {
        ...
        alert(`Booking at this parking slot has ended.`);
    }
